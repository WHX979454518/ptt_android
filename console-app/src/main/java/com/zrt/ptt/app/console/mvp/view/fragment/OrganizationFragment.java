...
public class OrganizationFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       /* contactEnterprise.observeOn(AndroidSchedulers.mainThread()).subscribe(enterprise->{
           ...
           OrgNodeBean org ;
            Log.e("contactDepartment:------->",""+contactDepartment);
...
//        initDatas();
        ...
        /*Observable<String> nomalObservable = Observable.create(new Observable.OnSubscribe<String>(){

        });
//        contactEnterprise.observeOn(AndroidSchedulers.mainThread()).subscribe(new Actio);
        contactEnterprise
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread()
                )
                .subscribe(new Subscriber<List<ContactEnterprise>>() {
                    ...
                    @Override
                    public void onNext(List<ContactEnterprise> contactEnterprises) {
